...
def xml_search(key,input_object):
    ...
    input_object : XML object to be parsed, test_data.py in this case
    ...
    def inner_function(key,input_object):
        ...
        else: # Iterate a list because some APIs return XML object in a list
            for val in input_object:
                if not isinstance(val, (str,int)):
                    inner_function(key,val)
    inner_function(key,input_object)
    return ret_val
print(xml_search("issueSummary",data))
